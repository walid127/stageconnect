                ...
                <>
                    ...
                    <div className="lg:hidden fixed top-20 left-0 right-0 z-50 max-h-[calc(100vh-5rem)] overflow-y-auto bg-gradient-to-b from-[#1a365d] to-[#2d3748] border-b border-[#4a5568] shadow-2xl">
                        <div className="px-4 py-4 space-y-1">
                            <Link to="/formateur/dashboard" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3 rounded-xl text-white/90 hover:text-white hover:bg-white/10 font-medium">Accueil</Link>
                            <Link to="/formateur/stages" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3 rounded-xl text-white/90 hover:text-white hover:bg-white/10 font-medium">Formations</Link>
                            <Link to="/formateur/history" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3 rounded-xl text-white/90 hover:text-white hover:bg-white/10 font-medium">Historique</Link>
                            <Link to="/formateur/diplomes" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3 rounded-xl text-white/90 hover:text-white hover:bg-white/10 font-medium">🎓 Mes Diplômes</Link>
                            <Link to="/formateur/profile" onClick={() => setMobileMenuOpen(false)} className="block px-4 py-3 rounded-xl text-white/90 hover:text-white hover:bg-white/10 font-medium">Mon Profil</Link>
                        </div>
                    </div>
                </>
            )}
