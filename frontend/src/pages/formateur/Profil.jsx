    ...
    const handleSave = async () => {
        try {
            ...
            setFormData({
                ...
                city: updatedUser.formateur?.ville || ''
            });
            
            // Vider les caches pertinents
            clearCache('formateur_dashboard');
            clearCache('formateur_profile');
            clearCache('formateur_trainings'); // Vider le cache des formations pour recharger avec le nouveau filtre
            
            setShowEditModal(false);
            showMessagePopup('✅ Profil mis à jour avec succès! Les formations seront filtrées par votre nouvelle spécialité.', 'success');
            
            // Rafraîchir la page des formations si elle est ouverte
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <InfoItem icon="📍" label="Ville" value={user.formateur?.ville || 'Non renseignée'} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <InfoItem icon="🎯" label="Spécialité" value={user.formateur?.specialite?.nom || 'Non renseignée'} />
