...
export default function FormateurMessages() {
    ...
    const sendMessage = async (e) => {
        ...
        try {
            ...
            showMessagePopup('Erreur lors de l\'envoi du message', 'error');
        } finally {
            setSending(false);
        }
    };
    ...
    const getUnreadCountFromUser = (userId) => {
        return messages.filter(
            (msg) =>
                            ...
                            <div className="flex-1 min-h-0 overflow-y-auto">
                                {users.filter(u => {
                                    ...
                                    if (searchQuery.trim()) {
                                        ...
                                        // Search by name or role (gestionaire only)
                                    ...
                                    const unreadCount = getUnreadCountFromUser(userItem.id);
