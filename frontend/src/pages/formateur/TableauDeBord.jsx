    ...
    return (
        <div className="app-container">
            ...
            <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pb-10 sm:pb-16 pt-3 sm:pt-4 relative z-20">
                ...
                {/* Accueil Intro */}
                <div className="mb-10">
                    <div className="relative overflow-hidden bg-gradient-to-br from-[#1a365d] via-[#2d3748] to-[#1a365d] dark:from-[#0f172a] dark:via-[#1e293b] dark:to-[#0f172a] rounded-3xl shadow-2xl border border-[#1a365d]/20 dark:border-[#334155]/30">
                        {/* Decorative Pattern */}
                        ...
                        <div className="relative p-8 md:p-10">
                            <div className="flex items-start gap-6">
                                ...
                                <div className="flex-shrink-0">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#d4af37] to-[#b8860b] rounded-2xl flex items-center justify-center shadow-xl shadow-[#d4af37]/20">
                                ...
                                <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-3">
                                        <h2 className="text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-white via-[#EDEDEC] to-[#d4af37] bg-clip-text text-transparent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    {/* Réguliers */}
                    <div className="group relative overflow-hidden bg-gradient-to-br from-white to-blue-50/50 dark:from-[#161615] dark:to-blue-950/20 rounded-3xl shadow-xl border border-blue-200/50 dark:border-blue-800/30 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-1 transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div className="relative p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="relative w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                    <span className="text-2xl filter drop-shadow-lg">📚</span>
                                    <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent rounded-2xl"></div>
                                </div>
                                <div className="text-4xl font-black bg-gradient-to-br from-[#1a365d] to-blue-600 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent">
                                    {loading || userLoading ? '…' : stats.availableTrainings}
                                </div>
                            </div>
                            <h3 className="text-lg font-bold text-[#1b1b18] dark:text-[#EDEDEC] group-hover:text-[#1a365d] dark:group-hover:text-blue-400 transition-colors duration-300">Formations disponibles</h3>
                        </div>
                    </div>

                    {/* Pédagogique */}
                    <div className="group relative overflow-hidden bg-gradient-to-br from-white to-indigo-50/50 dark:from-[#161615] dark:to-indigo-950/20 rounded-3xl shadow-xl border border-indigo-200/50 dark:border-indigo-800/30 hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-1 transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div className="relative p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="relative w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 dark:from-indigo-600 dark:to-purple-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                    <span className="text-2xl filter drop-shadow-lg">🎓</span>
                                    <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent rounded-2xl"></div>
                                </div>
                            ...
                            <h3 className="text-lg font-bold text-[#1b1b18] dark:text-[#EDEDEC] group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">Formation pédagogique</h3>
                        </div>
                    </div>

                    {/* Promotion */}
                    <div className="group relative overflow-hidden bg-gradient-to-br from-white to-amber-50/50 dark:from-[#161615] dark:to-amber-950/20 rounded-3xl shadow-xl border border-amber-200/50 dark:border-amber-800/30 hover:shadow-2xl hover:shadow-amber-500/20 hover:-translate-y-1 transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        <div className="relative p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="relative w-14 h-14 bg-gradient-to-br from-amber-500 to-yellow-600 dark:from-amber-600 dark:to-yellow-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                    <span className="text-2xl filter drop-shadow-lg">⭐</span>
                                    <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent rounded-2xl"></div>
                                </div>
                            </div>
                            <h3 className="text-lg font-bold text-[#1b1b18] dark:text-[#EDEDEC] group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors duration-300">Formation de promotion</h3>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-12">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white whitespace-nowrap">
                            Actions Rapides
                        </h2>
                        <div className="h-1 flex-1 bg-gradient-to-r from-[#1a365d] via-[#d4af37] to-[#0891b2] rounded-full"></div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-6 justify-center">
                        <Link to="/formateur/stages" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-[#1e40af] dark:hover:border-[#1e40af] transition-all duration-300 hover:shadow-lg hover:shadow-blue-900/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#1e40af] to-[#1e3a8a] rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">📚</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Explorer les Formations</h3>
                        ...
                        <Link to="/formateur/candidatures" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-[#0891b2] dark:hover:border-[#0891b2] transition-all duration-300 hover:shadow-lg hover:shadow-cyan-600/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#0891b2] to-[#0e7490] rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">📝</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Mes demandes de formation</h3>
                        ...
                        <Link to="/formateur/messages" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-purple-600 dark:hover:border-purple-600 transition-all duration-300 hover:shadow-lg hover:shadow-purple-600/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-purple-800 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">💬</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Messages</h3>
                        ...
                        <Link to="/formateur/profile" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-[#d4af37] dark:hover:border-[#d4af37] transition-all duration-300 hover:shadow-lg hover:shadow-yellow-600/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#d4af37] to-[#b8860b] rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">👤</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Mon Profil</h3>
                        ...
                        <Link to="/formateur/diplomes" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-emerald-600 dark:hover:border-emerald-600 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-600/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">🎓</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Mes Diplômes</h3>
                        ...
                        <Link to="/formateur/history" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-slate-600 dark:hover:border-slate-600 transition-all duration-300 hover:shadow-lg hover:shadow-slate-600/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-slate-600 to-slate-700 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">📜</span>
                                </div>
                                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Historique</h3>
                        ...
                        <Link to="/formateur/notifications" className="w-full md:w-1/2 lg:w-1/4 group relative overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 border-2 border-gray-100 dark:border-gray-700 hover:border-rose-600 dark:hover:border-rose-600 transition-all duration-300 hover:shadow-lg hover:shadow-rose-600/20">
                            <div className="flex flex-col items-center text-center">
                                <div className="w-16 h-16 bg-gradient-to-br from-rose-600 to-rose-700 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    <span className="text-3xl">🔔</span>
                                </div>
                ...
                <div className="relative group">
                    ...
                    <div className="relative overflow-hidden rounded-2xl bg-white/80 dark:bg-[#161615]/80 backdrop-blur-sm shadow-xl border border-white/20 dark:border-[#3E3E3A]/50 p-6 md:p-8">
