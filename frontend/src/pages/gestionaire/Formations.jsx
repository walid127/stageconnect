...
export default function FormationsGestionaire() {
    return (
        <div className="app-container">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 pt-6 relative z-20">
                {/* Row 1: 3 cards */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-rose-500 to-red-600 flex items-center justify-center mb-5 shadow-lg shadow-rose-500/30 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors duration-300">Formation</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Gérer les formations</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center mb-5 shadow-lg shadow-amber-500/30 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors duration-300">Demandes de formation</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Gérer les demandes de formation</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center mb-5 shadow-lg shadow-indigo-500/30 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">Formation Pédagogique</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Gérer les formations pédagogiques</p>
                ...
                <div className="flex flex-col sm:flex-row justify-center items-stretch gap-8 max-w-4xl mx-auto">
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center mb-5 shadow-lg shadow-emerald-500/30 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-500">
                                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">PSP1 (Promotion 5 ans)</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Gérer les promotions de 5 ans</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 to-fuchsia-600 flex items-center justify-center mb-5 shadow-lg shadow-violet-500/30 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                                </svg>
                            </div>
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">PSP2 (Promotion 10 ans)</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Gérer les promotions de 10 ans</p>
