                ...
                <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
                    ...
                    >
                        <div className="relative h-full rounded-[calc(0.75rem-2px)] bg-white dark:bg-[#1a1a18] p-3 sm:p-4 flex flex-col items-center text-center min-h-[118px] sm:min-h-[132px]">
                            ...
                            <p className="text-[11px] sm:text-xs text-[#78786c] dark:text-[#9D9D99] mb-2 flex-1 leading-snug line-clamp-3">Gérer les formations</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(0.75rem-2px)] bg-white dark:bg-[#1a1a18] p-3 sm:p-4 flex flex-col items-center text-center min-h-[118px] sm:min-h-[132px]">
                            ...
                            <p className="text-[11px] sm:text-xs text-[#78786c] dark:text-[#9D9D99] mb-2 flex-1 leading-snug line-clamp-3">Gérer les demandes de formation</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(0.75rem-2px)] bg-white dark:bg-[#1a1a18] p-3 sm:p-4 flex flex-col items-center text-center min-h-[118px] sm:min-h-[132px]">
                            ...
                            <p className="text-[11px] sm:text-xs text-[#78786c] dark:text-[#9D9D99] mb-2 flex-1 leading-snug line-clamp-3">Gérer les formations pédagogiques</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(0.75rem-2px)] bg-white dark:bg-[#1a1a18] p-3 sm:p-4 flex flex-col items-center text-center min-h-[118px] sm:min-h-[132px]">
                            ...
                            <h3 className="text-sm sm:text-base font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-0.5 sm:mb-1 leading-tight group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">PSP1 (Promotion 5 ans)</h3>
                            <p className="text-[11px] sm:text-xs text-[#78786c] dark:text-[#9D9D99] mb-2 flex-1 leading-snug line-clamp-3">Gérer les promotions de 5 ans</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(0.75rem-2px)] bg-white dark:bg-[#1a1a18] p-3 sm:p-4 flex flex-col items-center text-center min-h-[118px] sm:min-h-[132px]">
                            ...
                            <h3 className="text-sm sm:text-base font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-0.5 sm:mb-1 leading-tight group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">PSP2 (Promotion 10 ans)</h3>
                            <p className="text-[11px] sm:text-xs text-[#78786c] dark:text-[#9D9D99] mb-2 flex-1 leading-snug line-clamp-3">Gérer les promotions de 10 ans</p>
