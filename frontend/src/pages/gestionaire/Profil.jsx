...
export default function GestionaireProfile() {
    ...
    return (
        <div className="app-container">
            ...
            {showMessage && (
                <div className="fixed top-16 sm:top-24 right-3 sm:right-4 z-[9999] animate-slide-in-right max-w-[calc(100vw-1.5rem)]">
                    ...
                    <div className="relative bg-gradient-to-r from-[#1a365d] via-[#2d3748] to-[#1e293b] p-4 sm:p-6 md:p-12">
                        ...
                        <div className="relative flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6 md:gap-8">
                            ...
                            <div className="relative group">
                                <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-[#d4af37] via-[#b8860b] to-[#8b6914] rounded-2xl sm:rounded-3xl flex items-center justify-center text-white text-3xl sm:text-5xl font-bold shadow-xl sm:shadow-2xl transform group-hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6">
                            <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center gap-2">
                                <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gradient-to-br from-[#d4af37] to-[#b8860b] rounded-lg sm:rounded-xl flex items-center justify-center">
