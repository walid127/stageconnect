            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pb-6 sm:pb-16 pt-2 sm:pt-4 relative z-20">
                ...
                {loading ? (
                    ...
                    <div className="bg-white/95 dark:bg-[#161615]/95 rounded-xl shadow-md sm:rounded-2xl sm:shadow-lg border border-white/20 dark:border-[#3E3E3A]/50 overflow-x-auto">
                        {/* List Header */}
                        <div className="min-w-[920px] sc-table-header-gradient px-3 py-3 sm:px-6 sm:py-4">
                            <div className="grid min-w-[920px] grid-cols-12 gap-4 text-white font-semibold">
                        ...
                        <div className="divide-y divide-gray-200 dark:divide-gray-700">
                            {filteredUsers.map((u, index) => (
                                ...
                                >
                                    <div className="grid min-w-[920px] grid-cols-12 gap-4 items-center">
                                        {/* Index */}
