...
export default function PSP1Gestionaire() {
    ...
    const fetchPromotionTrainings = async () => {
        ...
        try {
            // Récupérer les formateurs avec formation de promotion 5 ans (PSP1)
            const response = await axios.get('/api/admin/formations-promotion?type_promotion=5_ans');
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 pb-6 sm:pb-16 pt-2 sm:pt-4 relative z-20">
                ...
                {loadingPromotion ? (
                    ...
                    <div className="text-center py-16">
                        ...
                        <p className="text-lg text-[#78786c] dark:text-[#9D9D99]">Aucune formation de promotion 5 ans (PSP1) disponible pour le moment.</p>
                    </div>
                ) : (
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
                    <div className="bg-white dark:bg-[#161615] rounded-2xl shadow-2xl border border-white/20 dark:border-[#3E3E3A]/50 w-full max-w-2xl max-h-[90vh] overflow-y-auto my-4">
                        <div className="bg-gradient-to-r from-[#1a365d] to-[#2d3748] p-6 text-white rounded-t-2xl">
                            <div className="flex justify-between items-center">
                                <div>
                                    <h2 className="text-xl font-bold">Modifier la Formation de Promotion PSP1</h2>
                                    <p className="text-white/80 text-sm">Formateur: {selectedFormateur.teacher_name}</p>
                                    <p className="text-white/70 text-xs mt-1">Formation de Promotion 5 ans</p>
                                </div>
                                <button
                                    type="button"
                                    onClick={() => { 
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); handleUpdatePromotion(); }} className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Titre de la formation PSP1 (5 ans)"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-[#78786c] dark:text-[#9D9D99] mb-2">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full px-4 py-3 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-xl text-[#1b1b18] dark:text-[#EDEDEC] bg-white dark:bg-[#0a0a0a] focus:border-[#1a365d] focus:ring-2 focus:ring-[#1a365d]/20"
                                    placeholder="Description de la formation de promotion 5 ans"
                                />
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
                    <div className="bg-white dark:bg-[#161615] rounded-2xl shadow-2xl border border-white/20 dark:border-[#3E3E3A]/50 w-full max-w-2xl max-h-[90vh] overflow-y-auto my-4">
                        <div className="bg-gradient-to-r from-[#1a365d] to-[#2d3748] p-6 text-white rounded-t-2xl">
                            <div className="flex justify-between items-center">
                                <div>
                                    <h2 className="text-xl font-bold">Créer une Formation de Promotion PSP1</h2>
                                    <p className="text-white/80 text-sm">Formateur: {selectedFormateur.teacher_name}</p>
                                    <p className="text-white/70 text-xs mt-1">Formation de Promotion 5 ans</p>
                                </div>
                                <button
                        ...
                        <form onSubmit={(e) => { e.preventDefault(); handleCreatePromotion(); }} className="p-6 space-y-4">
                            ...
                            <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 bg-gray-50/60 dark:bg-gray-900/40 space-y-3">
                                ...
                                <p className="text-xs text-[#78786c] dark:text-[#9D9D99]">
                                    Si vous ajoutez un emploi du temps ici, il sera partagé avec ce formateur pour toute la formation de promotion (PSP1).
                                </p>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
            ...
            <DeleteConfirmModal
                ...
                itemDetails={
                    <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mt-1">
                        {promotionToCancel?.teacher_name || 'N/A'} - PSP1
                    </p>
                }
