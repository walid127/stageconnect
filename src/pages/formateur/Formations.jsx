                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Consulter et postuler aux formations disponibles</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Suivre vos demandes de formation</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Gérer votre formation pédagogique</p>
                ...
                <div className="flex flex-col sm:flex-row justify-center items-stretch gap-8 max-w-4xl mx-auto">
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">PSFEP1</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Formation de Promotion</p>
                    ...
                    >
                        <div className="relative h-full rounded-[calc(2rem-2px)] bg-white dark:bg-[#1a1a18] p-8 flex flex-col items-center text-center min-h-[220px]">
                            ...
                            <h3 className="text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC] mb-2 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">PSFEP2</h3>
                            <p className="text-sm text-[#78786c] dark:text-[#9D9D99] mb-4 flex-1">Formation de Promotion</p>
